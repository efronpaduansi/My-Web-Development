        ...
        <div id="content">
            ...
            <div class="container" id="form-container">
                <div class="col-md-4">
                    ...
                    <!-- Ambil data ditampilkan dalam form -->
                    <?php
    
                        include 'koneksi.php';

                        $id = $_GET['id'];
                        $data = mysqli_query($conn, "SELECT * FROM tbMahasiswa WHERE id='$id'");
                     ...
                     <form action="update.php" method="post">
                        ...
                        <input type="hidden" name="id" value="<?php echo $mhs['id']; ?>">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" name="nim" id="nim" class="form-control" value="<?php echo $mhs['nim']; ?>">
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" name="kelas" id="kelas" class="form-control" value="<?php echo $mhs['kelas']; ?>">
                         </div>
                          <div class="form-group">
                             <label for="kehadiran">KEHADIRAN</label>
                             <input type="text" name="kehadiran" id="kehadiran" class="form-control" value="<?php echo $mhs['kehadiran']; ?>">
                         </div>
                         <div class="form-group">
                             <label for="tugas">TUGAS</label>
                             <input type="text" name="tugas" id="tugas" class="form-control" value="<?php echo $mhs['tugas']; ?>">
                         </div>
                         <div class="form-group">
                             <label for="uts">UTS</label>
                             <input type="text" name="uts" id="uts" class="form-control" value="<?php echo $mhs['uts']; ?>">
                         </div>
                         <div class="form-group">
                             <label for="uas">UAS</label>
                             <input type="text" name="uas" id="uas" class="form-control" value="<?php echo $mhs['uas']; ?>">
                         </div>
